...
abstract class AbstractCommand extends Command
{
    ...
    {
        $key = static::class;
        if (!isset(self::$command[$key]) || !(self::$command instanceof static)) {
            self::$command[$key] = new static($params);
        }
     ...
     * @return mixed
     */
    abstract protected function __init(InputInterface $input, OutputInterface $output);
     ...
     * @return bool
     */
    public function choice($question, array $choices, $default = null, $attempts = null, $multiple = true)
    {
        $helper = $this->getHelperSet()->get('question');
